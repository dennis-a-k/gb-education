...
<form class="create" action="{{ route('submit') }}" method="post">
  ...
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" id="customRadioInline1" name="category" class="custom-control-input" value="good-news" checked>
    <label class="custom-control-label" for="customRadioInline1">Good News</label>
  </div>
  <div class="custom-control custom-radio custom-control-inline">
    <input type="radio" id="customRadioInline2" name="category" class="custom-control-input" value="bad-news">
